...
export default function Market() {
  ...
  async function fetchMarkets() {
    try {
      ...
      console.log(error);
      Alert.alert('Error', 'An error occurred while fetching markets',
        [
  ...
  async function handleOpenCamera(){
    try{
      ...
      if(!granted){
        return Alert.alert("Camera permission is required to read QR Code");
      }
  ...
  async function getCoupon(id: string){
    try{
      ...
      console.log(error);
      Alert.alert('Error', 'An error occurred while fetching coupon');
    } finally { 
